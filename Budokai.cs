...
class Budokai
{
    public static void Main(string[] args)
    {
        ...
        Pokemon charmander = new Pokemon(answer_pokemonname, "Fire", 100);
        Pokeball Pokeball1 = new Pokeball(charmander);

        trainer1.AddToBelt(Pokeball1, PokeballIndex);
        ...
        Console.WriteLine(Pokeball1.getPokemon().getType());
        Console.WriteLine(Pokeball1.getPokemon().getHP());
        Console.WriteLine("===============");
        string? answer1 = "y";
      while (answer1 == "y"){
